/*
 *
 *	pixcipub.h	External	10-Nov-2022
 *
...
int  _cfunregparm0 wrapped_ttyopen(void *tty, int index, void **pxttyp);
...
extern int   pxdrv_ttyopen(void *tty, int index, void **pxttyp);
