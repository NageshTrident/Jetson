/*
 *
 *	pixcipub.h	External	26-Jan-2020
 *
...
void*_cfunregparm0 wrapped_pxdrv_mmapdope1(void *filep, ulong adrs, dma_addr_t dma_handlep[], ulong sizep[], struct pci_dev *devp[]);
