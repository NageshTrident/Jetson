/**                                                                               
 *                                                                                
 *      pixciv4l.c         External       24-JAN-2023         
 *                                                                                
...
#include <media/videobuf2-vmalloc.h>
  ...
  #endif
  MODULE_VERSION("3.8.01" "-" "23.01.24.115502");
  /**
 ...
 * increasing the number of 'pixels' per row so as to accomodate
 * the entire row of the image).
 *
 **/
static u32
...
init_pxdrvv4l2(void)
{
    int r = 0;
    int nPixci = 0;
    printk(KERN_INFO "%s %s loaded\n", XCDRV_IDV4LN, "3.8.01" " " "[23.01.24.115502]" );
